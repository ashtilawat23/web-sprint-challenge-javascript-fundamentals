...
const zooAnimals = [
 ...
 function lowerCaseNames(){
  const lowerCaseArray = zooAnimals.map(function(item){
...
console.log(lowerCaseNames())
  ...
  */
  function lowPopulationAnimals(){
    const lowPopulationArray = zooAnimals.filter(function(item){
  ...
  */
  ...
  function USApop(){
    const USApopReduce = zooAnimals.reduce(function(accumulator,item){
